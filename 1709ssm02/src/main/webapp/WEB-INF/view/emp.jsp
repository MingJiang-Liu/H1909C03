...
<body class="gray-bg">
				...
				<div class="input-group">
					...
					<select class="form-control" name="txt_search_roleid" id = "txt_search_roleid">
						...
						<c:forEach items="${dList }" var="d">
						 	<option value="${d.depid }">${d.dname }</option>
						</c:forEach>
                	</select>
				</div>
			 </div>
					...
					<form id="form_user" method="post" action="reserveEmp.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>角色：</td>
								<td colspan="4">
									<select class="form-control" name="depid" id = "roleid" aria-required="true" required>
	...
	<div class="modal fade" id="modal_user_in" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_in" method="post" action="inEmp.htm" enctype="multipart/form-data">
						<input type="file" name="file" id="fid" />
	...
	var TableInit = function () {
	    ...
	    oTableInit.queryParams = function (params) {
	        var temp = {//这里的键的名字和控制器的变量名必须一致，这边改动，控制器也需要改成一样的
	            ...
	            //usertype:$("#txt_search_roleid").val(), $("#txt_search_usertype").val(),
