					...
					<form id="form_user" method="post" action="reserveStu.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>学生爱好：</td>
								<td>
									<input type="checkbox" name="hobbys" value="LOL">LOL
									<input type="checkbox" name="hobbys" value="WOW">WOW
									<input type="checkbox" name="hobbys" value="吃鸡">吃鸡
									<input type="checkbox" name="hobbys" value="王者农药">王者农药
								</td>
								<td>&nbsp;&nbsp;</td>
							</tr>
							<tr>
								<td>学生生日：</td>
								<td>
									<input type="date" id="bid" name="birthday">
								</td>
								<td>&nbsp;&nbsp;</td>
							</tr>
							<tr>
